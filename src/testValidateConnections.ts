...
const testCases = [
  ...
  },
  {
    ...
    edges: [{ id: "e1", source: "node1", target: "start" }] as Edge[],
    expectedErrors: 2, 
  },
  {
  ...
  },
  {
    ...
    edges: [{ id: "e1", source: "start", target: "node1" }] as Edge[],
    expectedErrors: 1, 
  },
  {
...
testCases.forEach((testCase, index) => {
  ...
  console.log(
    `Expected errors: ${testCase.expectedErrors}, Actual errors: ${errorCount}`
  );
