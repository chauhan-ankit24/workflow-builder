...
interface FollowUserNodeProps {
  data: FollowUserNodeConfig;
}

const FollowUserNode: React.FC<FollowUserNodeProps> = ({ data }) => {
  return (
    <div className="px-4 py-2 shadow-md rounded-md bg-pink-500 border-2 border-stone-400 relative group">
